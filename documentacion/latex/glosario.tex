...
\newglossaryentry{redis}{
    name={Redis},
    description={Base de datos llave-valor que solo guarda en memoria. Rápida pero no persistente, para tokens}
}
...
\newglossaryentry{adhoc}{
    name={Ad-Hoc},
    description={Especifico a un fin, sin integración en una solución general}
}